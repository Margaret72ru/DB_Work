INSERT INTO "HomeWork".album ("Name","Year") VALUES
...
INSERT INTO "HomeWork".album_author (author_id,album_id) VALUES
	 (2,1),
	 (9,2),
	 (10,3),
	 (10,4),
	 ...
	 (8,8),
	 (1,9);
INSERT INTO "HomeWork".album_mix ("Name","Year") VALUES
	 ('Summer','2020-01-01'),
	 ('Spring','2021-01-01'),
	 ('Winter','2022-01-01'),
	 ('Autumn','2018-01-01'),
...
INSERT INTO "HomeWork".album_mix_songs (album_mix_id,song_id) VALUES
	 (1,1),
	 (1,15),
	 (2,2),
	 (2,14),
...
INSERT INTO "HomeWork".album_mix_songs (album_mix_id,song_id) VALUES
	 ...
	 (7,9),
	 (8,8);
INSERT INTO "HomeWork".author ("Name") VALUES
	 ('Михайл Круг'),
	 ('Taylor Swift'),
	 ('Бо Диддли'),
	 ('Леонид Утесов'),
	 ...
	 ('Billie Eilish'),
	 ('Ariana Grande');
INSERT INTO "HomeWork".genre ("Name") VALUES
	 ('Рок'),
	 ('Регги'),
	 ('Кантри'),
	 ('Поп-музыка'),
	 ...
	 ('Романс'),
	 ('Диско');
INSERT INTO "HomeWork".genre_author (genre_id,author_id) VALUES
	 (1,7),
	 (1,8),
	 (2,5),
	 (3,2),
